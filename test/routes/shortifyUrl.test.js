...
describe('Test GET shortify route', () => {
  beforeEach(done => Models.urls.create({ longUrl: 'www.somelonglongurl', shortUrl: 'asdasd' }).then(done()));
  afterEach(done => Models.urls.destroy({ where: { longUrl: 'www.somelonglongurl', shortUrl: 'asdasd' } }).then(done()));
  it('should gives 200 as success code', (done) => {
    supertest(server.listener)
